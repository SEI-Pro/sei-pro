(() => {
  ...
  function rowHtml(value, index, arrayProcessosUnidade) {
    ...
    return '<tr data-tagname="SemGrupo" data-index="' + index + '" data-id_procedimento="' + id + '"><td align="center"><input type="checkbox" data-act="row-check" id="monitoradoPro_' + id + '" name="monitoradoPro" value="' + id + '"></td><td align="left"><a class="followLinkProcesso bLink" style="text-decoration:underline;" href="' + linkDoc + '"><i class="' + iconProcesso + ' bLink" style="text-decoration:underline;" title="' + tipsProcesso + '"></i> ' + esc(value.processo) + '</a><a class="newLink followLink followLinkNewtab" href="' + linkDoc + '" title="Abrir em nova aba" target="_blank"><i class="fas fa-external-link-alt" style="font-size:90%;text-decoration:underline;"></i></a><div class="seipro-monitorado-native-icons">' + htmlIconsHome + '</div></td><td align="left" class="seipro-monitorado-native-cell" data-native="prazo"></td><td align="left" class="seipro-monitorado-native-cell" data-native="marcador"></td><td class="seipro-monitorado-native-cell" data-native="anotacao"></td><td class="seipro-monitorado-type-cell"><span data-native="tipo"></span><a class="newLink followLink followLinkTags seipro-monitorado-remove-row" data-act="remove-row" title="Remover dos Processos Monitorados"><i class="fas fa-trash-alt"></i></a></td><td class="seipro-monitorado-category-cell"><span class="seipro-monitorado-category-text">' + (categoria ? esc(categoria) : "") + '</span><span class="seipro-monitorado-category-editor" style="display:none"></span><a class="newLink followLink followLinkTags seipro-monitorado-category-edit" data-act="category-edit" title="Editar categoria"><i class="fas fa-pencil-alt"></i></a></td><td align="center" data-order="' + order + '"><a class="newLink seipro-monitorado-sorter" style="margin-right:20px;cursor:grab;"><span class="fa-layers fa-fw"><i class="fas fa-bars cinzaColor"></i>' + (issetOrder ? '<span class="fa-layers-counter">' + value.order + "</span>" : "") + "</span></a></td></tr>";
  }
  function panelHtml() {
    const jp = globalRef.jmespath;

(() => {
  ...
  function rowHtml(value, index, arrayProcessosUnidade) {
    ...
    return '<tr data-tagname="SemGrupo" data-index="' + index + '" data-id_procedimento="' + id + '"><td align="center"><input type="checkbox" data-act="row-check" id="monitoradoPro_' + id + '" name="monitoradoPro" value="' + id + '"></td><td align="left"><a class="seipro-monitorado-process-link bLink" style="text-decoration:underline;" href="' + linkDoc + '"><i class="' + iconProcesso + ' bLink" style="text-decoration:underline;" title="' + tipsProcesso + '"></i> ' + esc(value.processo) + '</a><a class="newLink followLink followLinkNewtab" href="' + linkDoc + '" title="Abrir em nova aba" target="_blank"><i class="fas fa-external-link-alt" style="font-size:90%;text-decoration:underline;"></i></a><div class="seipro-monitorado-native-icons">' + htmlIconsHome + '</div></td><td align="left" class="seipro-monitorado-native-cell" data-native="prazo"></td><td align="left" class="seipro-monitorado-native-cell" data-native="marcador"></td><td class="seipro-monitorado-native-cell" data-native="anotacao"></td><td class="seipro-monitorado-type-cell"><span data-native="tipo"></span><a class="newLink followLink followLinkTags seipro-monitorado-remove-row" data-act="remove-row" title="Remover dos Processos Monitorados"><i class="fas fa-trash-alt"></i></a></td><td class="seipro-monitorado-category-cell"><span class="seipro-monitorado-category-text">' + (categoria ? esc(categoria) : "") + '</span><span class="seipro-monitorado-category-editor" style="display:none"></span><a class="newLink followLink followLinkTags seipro-monitorado-category-edit" data-act="category-edit" title="Editar categoria"><i class="fas fa-pencil-alt"></i></a></td><td align="center" data-order="' + order + '"><a class="newLink seipro-monitorado-sorter" style="margin-right:20px;cursor:grab;"><span class="fa-layers fa-fw"><i class="fas fa-bars cinzaColor"></i>' + (issetOrder ? '<span class="fa-layers-counter">' + value.order + "</span>" : "") + "</span></a></td></tr>";
  }
  function panelHtml() {
    const jp = globalRef.jmespath;
    ...
    return { idOrder, html: '<div class="panelHomePro" style="display:inline-block;width:100%;" id="monitoradosPro" data-order="' + idOrder + '"><div class="infraBarraLocalizacao titlePanelHome"><i class="fas fa-star starGold" style="margin:0 5px;font-size:1.1em;"></i> Processos Monitorados<a class="newLink" id="monitoradosProDiv_showIcon" data-act="toggle-show" title="Mostrar Tabela" style="font-size:11pt;' + iconShow + '"><i class="fas fa-plus-square cinzaColor"></i></a><a class="newLink" id="monitoradosProDiv_hideIcon" data-act="toggle-hide" title="Recolher Tabela" style="font-size:11pt;' + iconHide + '"><i class="fas fa-minus-square cinzaColor"></i></a></div><div id="monitoradosProDiv" class="panelHome" style="width:100%;' + statusView + '"><div id="monitoradosProActions" style="top:0;position:absolute;z-index:9999;left:190px;width:calc(100% - 230px)"><a class="newLink seipro-monitorados-remove-selected" data-act="remove-selected" title="Remover processos monitorados" style="margin:0;font-size:14pt;display:none"><span class="fa-layers fa-fw"><i class="fas fa-trash-alt"></i><span class="fa-layers-counter">1</span></span></a><span style="display:block;float:right;width:200px;">' + selectCategory + '</span><a class="newLink seipro-monitorados-update" data-act="update" title="Atualizar Informa\xE7\xF5es" style="margin-right:10px;font-size:14pt;float:right;"><i class="fas fa-sync-alt"></i></a><a class="newLink seipro-monitorados-config" data-act="config" title="Configura\xE7\xF5es" style="margin:0;font-size:14pt;float:right;"><i class="fas fa-cog"></i></a></div><div class="seipro-monitorados-scroll">' + table + "</div></div></div>" };
  }
  ...
  var configDateClass = (type) => configDateClassByType[type] || "configDates_" + type;
  ...
  function formHtml(configdate, id_procedimento, store, monitoradoIndex) {
    ...
    return '<div id="configDatesBox"><table style="font-size:10pt;width:100%;" class="seiProForm"><tr style="height:40px;"><td colspan="2">Contar o tempo decorrido do processo a partir:</td></tr>' + swRow("fa-file-signature", "Da data de assinatura de um documento", "selectdoc", "selectdoc", configdate.selectdoc, "switch-selectdoc", 'data-id="' + id_procedimento + '"') + '<tr style="height:40px;' + sw(configdate.selectdoc, "", "display:none") + '" class="seipro-monitorado-dates-selectdoc"><td colspan="2"><select data-act="setupdate" id="configDatesBox_listdocs">' + docsOptions + '</select></td></tr><tr style="height:10px;display:none" class="seipro-monitorado-dates-selectdoc"><td colspan="2"></td></tr>' + swRow("fa-calendar-check", "De uma data espec\xEDfica", "setdate", "setdate", configdate.setdate) + '<tr style="height:40px;' + sw(configdate.setdate, "", "display:none") + '" class="seipro-monitorado-dates-setdate"><td><i class="iconPopup fas fa-clock cinzaColor"></i> Data referencial</td><td><input type="date" data-act="preview" id="configDatesBox_date" value="' + configdate.date + '" style="width:130px;float:right;"></td></tr><tr style="height:10px;"><td colspan="2"><a class="newLink ' + sw(configdate.advanced, "newLink_active", "") + '" data-act="advanced" style="font-size:10pt;cursor:pointer;margin:5px 0 0 0;float:right;"><i class="fas fa-wrench cinzaColor"></i> Op\xE7\xF5es avan\xE7adas</a></td></tr></table><table style="font-size:10pt;width:100%;' + sw(configdate.advanced, "", "display:none") + '" class="seiProForm seipro-monitorado-dates-advanced"><tr class="hrForm"><td colspan="4"></td></tr><tr style="height:40px;"><td colspan="2">Visualizar o resultado:</td></tr>' + swRow("fa-stopwatch", "Em tempo relativo", "countdown", "countdown", configdate.countdown) + swRow("fa-calendar-day", "Em n\xFAmero de dias", "countdays", "countdays", configdate.countdays) + '<tr style="height:40px;' + sw(configdate.countdays, "", "display:none") + '" class="seipro-monitorado-dates-countdays"><td><i class="iconPopup iconSwitch fas fa-briefcase ' + sw(configdate.workday, "azulColor", "cinzaColor") + '"></i> Calcular em dias \xFAteis</td><td><div class="onoffswitch" style="float:right;"><input type="checkbox" data-act="switch-icon" class="onoffswitch-checkbox" id="configDatesBox_workday" data-type="workday" tabindex="0" ' + (configdate.workday ? "checked" : "") + '><label class="onoff-switch-label" for="configDatesBox_workday"></label></div></td></tr><tr class="hrForm"><td colspan="4"></td></tr><tr style="height:40px;"><td colspan="2">Sinalizar a partir:</td></tr>' + swRow("fa-pen-fancy", "Da assinatura de um novo documento (EM BREVE)", "newdoc", "newdoc", configdate.newdoc) + '<tr class="seipro-monitorado-dates-newdoc"><td colspan="2"><span id="configDatesBox_newdoclist">' + appendArrayNewdoclist(configdate.newdoclist) + '</span></td></tr><tr style="height:40px;' + sw(configdate.newdoc, "", "display:none") + '" class="seipro-monitorado-dates-newdoc"><td colspan="2"><select id="configDatesBox_listnewdoc" data-act="docs-change"><option value="0">Qualquer tipo de documento</option>' + tiposOptions + '</select></td></tr><tr style="height:10px;"><td colspan="2"></td></tr>' + swRow("fa-hourglass-half", "Do n\xFAmero de dias decorridos", "duedate", "duedate", configdate.duedate) + '<tr style="height:40px;' + sw(configdate.duedate, "", "display:none") + '" class="seipro-monitorado-dates-duedate"><td colspan="2"><input type="number" data-act="preview" id="configDatesBox_duenumber" value="' + duenumber + '" style="width:40px;margin-left:35px !important;" min="0"> dias <select id="configDatesBox_duecounter" data-act="preview" style="width:auto;"><option value="corrido" ' + sw(configdate.duecounter === "corrido", "selected", "") + '>corridos</option><option value="util" ' + sw(configdate.duecounter === "util", "selected", "") + '>\xFAteis</option></select><select id="configDatesBox_duemode" data-act="preview" style="width:auto;"><option value="depois" ' + sw(configdate.duemode === "depois", "selected", "") + '>depois</option><option value="antes" ' + sw(configdate.duemode === "antes", "selected", "") + '>antes</option></select><span class="seipro-monitorado-dates-selectdoc" style="display:none">da data de assinatura</span><span class="seipro-monitorado-dates-setdate">da data de refer\xEAncia</span></td></tr><tr style="height:10px;" class="seipro-monitorado-dates-duedate"><td colspan="2"></td></tr>' + swRow("fa-calendar-alt", "De uma data de vencimento espec\xEDfica", "duesetdate", "duesetdate", configdate.duesetdate) + '<tr style="height:40px;' + sw(configdate.duesetdate, "", "display:none") + '" class="seipro-monitorado-dates-duesetdate"><td><i class="iconPopup iconSwitch fas fa-clock cinzaColor"></i> Data de vencimento</td><td><input type="date" data-act="preview" id="configDatesBox_duesetdt" value="' + configdate.dateDue + '" style="width:130px;float:right;"></td></tr></table><table style="font-size:10pt;width:100%;" class="seiProForm"><tr class="hrForm"><td colspan="4"></td></tr><tr style="height:40px;"><td colspan="2">Pr\xE9via:</td></tr><tr style="height:40px;"><td colspan="2"><div id="dateboxPreview" style="display:none;text-align:center;"></div></td></tr></table><input type="hidden" value="' + id_procedimento + '" id="configDatesBox_id_procedimento"></div>';
  }
  function switchGroup(el, o1, o2, o3) {
    ...
    if (group.indexOf(type) !== -1) {
      ...
      group.forEach((opt2) => {
        ...
        qsa("." + configDateClass(opt2)).forEach((n) => {
  ...
  function advanced(el) {
    qsa(".seipro-monitorado-dates-advanced").forEach((n) => {
  ...
  function actionMonitoradoCheckbox(el) {
    ...
    if (el.checked) {
      ...
      if (optionsDiv) {
        ...
        optionsDiv.querySelectorAll(".selectPro, #monitoradoPrazoSend, .seipro-monitorado-tags-input").forEach((i) => {
          i.value = "";
        });
  ...
  function monitoradosLabelOptions(id_procedimento) {
    ...
    return '<table style="font-size:10pt;width:100%;min-width:610px;" class="seiProForm"><tr data-id_procedimento="' + id_procedimento + '" data-index="0"><td style="vertical-align:bottom;text-align:left;" class="label"><label for="categoria_monitorado"><i class="iconPopup iconSwitch fas fa-layer-group cinzaColor"></i>Categoria:</label></td><td>' + catSelect + '</td><td style="vertical-align:bottom;" class="label"><label class="last" for="monitoradoPrazoSend"><i class="iconPopup iconSwitch fas fa-stopwatch cinzaColor" style="float:initial;"></i>Prazo:</label></td><td><span class="seipro-monitorado-dates-editor"><input id="monitoradoPrazoSend" value="' + dateVal + '" style="width:120px;background:#f9fafa;" data-act="dates-hide-blur" data-key="dates" type="date" class="seipro-monitorado-dates" name="monitoradoPrazoSend"><a class="newLink seipro-monitorado-config-dates" data-act="dates-config" style="padding:5px 8px;margin:8px 2px 0 10px;font-size:10pt;" title="Op\xE7\xF5es"><i class="fas fa-cog"></i></a></span></td></tr><tr data-id_procedimento="' + id_procedimento + '" data-index="0" style="height:40px;"><td align="left" class="seipro-monitorado-tags-cell" data-etiqueta-mode="monitorado" colspan="4"><span class="info_tags_follow">' + tagsHtml + '</span><span class="info_tags_follow_txt" style="display:none;margin-top:-8px !important;"><input value="' + tagsMonitorado + '" class="seipro-monitorado-tags-input" name="monitoradoTagsPro"></span><a class="newLink seipro-monitorado-tags-add" data-act="tags-show" style="font-size:10pt;"><i class="fas fa-tags"></i> Adicionar etiqueta</a></td></tr></table>';
  }
  ...
  function showDatesMonitorado(el, mode) {
    ...
    if (!(configBtn && configBtn.matches(":hover"))) {
      if (table) {
        ...
        qsa(".seipro-monitorado-dates-editor", table).forEach((n) => {

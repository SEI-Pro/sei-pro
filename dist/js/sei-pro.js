(() => {
  ...
  function getNewTabProcesso() {
    ...
    setTimeout(function() {
      ...
      htmlBtnAtiv = parent.checkConfigValue("gerenciaratividades") && localStorage.getItem("configBasePro_atividades") !== null && typeof checkCapacidade !== "undefined" && parent.checkCapacidade("save_atividade") && typeof __ !== "undefined" ? '<a tabindex="451" class="botaoSEI botaoSEI_hide ' + (iconLabel ? "iconLabel" : "") + " iconBoxAtividade " + (iconBoxSlim ? "iconBoxSlim" : "") + ' iconPro_Observe iconAtividade_save" ' + (iconLabel ? "" : `onmouseout="return infraTooltipOcultar();" onmouseover="return infraTooltipMostrar('` + __.Nova_Demanda + `')"`) + ' onclick="parent.saveAtividade()" style="position: relative; margin-left: -3px;">    <img class="infraCorBarraSistema" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" title="' + __.Nova_Demanda + '">    <span class="botaoSEI_iconBox">       <i class="fad fa-user-check" style="font-size: 17pt; color: #fff;"></i>    </span>' + (iconLabel ? '    <span class="newIconTitle">' + __.Nova_Demanda + "</span>" : "") + "</a>" : "";

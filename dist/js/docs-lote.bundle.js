(() => {
  ...
  function erroBox(textError = "") {
    return wrap(`<div class="seipro-doclote-error-dialog">
                        <p><i class="fas fa-exclamation-triangle vermelhoColor seipro-doclote-error-icon"></i> Eita! Algo deu errado na replica\xE7\xE3o de documentos \u{1F614}</p>
                        <br>
...
`;
  ...
  function docsLote_CSVAnalysis(file) {
    $("#fieldListCSV").remove();
    if (!$("#loaderAnalysisCSV")[0]) $("#dialogBoxDocLote").append(`<div id='loaderAnalysisCSV' class="seipro-doclote-csv-analysis-loader" style='height: 40px; text-align: center; display: block;'><i class="fas fa-spinner fa-spin azulColor seipro-doclote-csv-analysis-spinner" style="scale:3;"></i></div>`);
    Papa.parse(file, {
      header: true,

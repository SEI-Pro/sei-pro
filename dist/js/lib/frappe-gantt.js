...
class Bar {
    ...
    prepare_values() {
        ...
        this.group = createSVG('g', {
            class: 'bar-wrapper ' + (this.task.custom_class || '') + ( (this.gantt.options.edit_task) ? ' edit-task' : '' ),
    ...
    draw_resize_handles() {
        ...
        // INSERIDO CONDICIONANTE DE EDICAO DO CONFIG 
        if (this.gantt.options.edit_task) {
            createSVG('rect', {
    ...
    bind_bar_events() {
        ...
        $.on(this.$svg, 'mousemove', e => {
            ...
            bars.forEach(bar => {
                ...
                // INSERIDO CONDICIONANTE DE EDICAO DO CONFIG
                //} else if (is_dragging ) {
                } else if (is_dragging && this.options.edit_task) {

...
describe('migration: atividades full ESM facade', () => {
  it('instala a ponte dedicada e compõe todas as fatias migradas', () => {
    ...
    expect(index).toContain("import { installAtividadesLegacyApi, atividadesLegacyApi } from './legacy-api.js';");
    ...
    expect(index).toContain("import { initAtividades, initPerfilLoginAtiv, checkHostPermission } from './boot.js';");
    ...
    expect(index).toContain('handlers: atividadesHandlers');
    expect(index).toContain('getServerAtividades');
    expect(index).toContain('saveAtividade:');
    expect(index).toContain('checkCapacidade:');
    expect(index).toContain('actionsAtividade:');
    expect(index).toContain('initEmptyAtividades:');
    expect(index).toContain('getResendKey:');
    expect(index).toContain('insertIconAtividade:');
    expect(index).toContain('getAtividades:');
    expect(index).toContain('getKanbanItem:');
    expect(index).toContain('checkPerfilNivelAdm:');

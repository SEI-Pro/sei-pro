...
const SELECTOR_ALLOWLIST = [
    ...
    'src/features/atividades/panel.ts',
    ...
    'src/features/sei-functions/batch-capa.ts',
    'src/features/sei-functions/boot.ts',
    'src/features/sei-functions/layout-dialogs.ts',
    'src/features/sei-functions/marcadores-arvore.ts',
    'src/features/sei-functions/media-viewers.ts',
    'src/features/sei-functions/notifications-process.ts',
    'src/features/sei-functions/slim-ui-chrome.ts',
    // Property name ancoraArvoreDownload still trips the ratchet regex; literals removed.
    'src/features/sei-functions/state.ts',
    'src/features/sei-functions/tags-menus.ts',
    'src/features/sei-functions/visualizacao-toolbar.ts',
    'src/features/sei-functions/wait-load-home.ts',
    'src/features/sei-functions/wizards-menu.ts',

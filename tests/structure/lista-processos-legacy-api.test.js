...
describe('migration: lista-processos full ESM facade', () => {
  ...
  it('não mantém o monolito body.js nem a cópia sei-pro.js em src/', () => {
    ...
    expect(existsSync(join(rootDir, 'src/features/lista-processos/modules.js'))).toBe(true);
    expect(existsSync(join(rootDir, 'src/features/lista-processos/boot.js'))).toBe(true);

...
- Arquivos JS analisados: **309**.
- Funções extraídas: **3871**.
- Opções/configurações encontradas: **72**.
- Funções compartilhadas por mais de uma opção: **1076**.
- Funções sem vínculo estático com opções: **2462**.
...
| `addNewsRowsTableTabConfig` | `src/features/atividades/body.js:4680` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
...
| `confirmaFraseBoxPro` | `src/features/atividades/body.js:25636` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
...
| `getChartPlanosTrabalho` | `src/features/atividades/body.js:1811` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
| `getContentDocSEI` | `src/features/sei-functions/body.js:1629` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
| `getServerAtividades` | `src/features/atividades/body.js:239` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
| `getTabConfig` | `src/features/atividades/body.js:3988` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
| `getTabReport` | `src/features/atividades/body.js:3661` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
...
| `initMaskPhoneConfig` | `src/features/atividades/body.js:3941` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
...
| `insertActionHipoteseLegal` | `src/features/sei-functions/body.js:10336` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
...
| `ratePlano` | `src/features/atividades/body.js:24653` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
| `ratePrograma` | `src/features/atividades/body.js:24584` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
...
| `saveAfastamento` | `src/features/atividades/body.js:15252` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
| `saveAtividadeQuick` | `src/features/atividades/body.js:19486` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
...
| `viewEspecifacaoProcesso` | `src/features/sei-functions/body.js:1966` | `feature` | 46 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
| `$` | `src/features/sei-functions/body.js:12118` | `feature` | 45 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |
| `addNewItemSelect` | `src/features/sei-functions/body.js:1980` | `feature` | 45 | `agruparlista`, `atalhopublicacoeseletronicas`, `certidaosigilo`, `citacaodoc`, `contadoricone`, `coresmarcadores`, `debugpage`, `disablequery`, `ditado`, `editarimagens`, `editarlinks`, `escrivainterativa` ... |

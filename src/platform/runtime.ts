...
import { publishGlobal, getSeiPro, globalRef } from '../core/global.js';
...
export function createRuntime() {
    ...
    publishGlobal('getUrlExtension', getUrlExtension);
    publishGlobal('getManifestExtension', getManifestExtension);
    publishGlobal('pathExtensionSEIPro', pathExtensionSEIPro);

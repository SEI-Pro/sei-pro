...
import { publishGlobal, getSeiPro } from '../core/global.js';
...
export function installTooltip() {
    ...
    publishGlobal('extractTooltip', extractTooltip);
    publishGlobal('extractTooltipToArray', extractTooltipToArray);
    return tooltip;
}

...
export function installCor() {
    ...
    publishGlobal('componentToHex', componentToHex);
    publishGlobal('rgbToHex', rgbToHex);
    publishGlobal('rgbToHexString', rgbToHexString);
    publishGlobal('hexToRgb', hexToRgb);
    publishGlobal('addAlpha', addAlpha);
    publishGlobal('getBrightnessColor', getBrightnessColor);

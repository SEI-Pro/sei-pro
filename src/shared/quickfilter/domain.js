...
import { removeAcentos, uniqPro } from '../../core/util.js';

/**
 * Núcleo PURO do filtro rápido de página (config `filtrarpaginapelapesquisarapida`).
 * Sem DOM, jQuery ou estado próprio. Antes em core/; agora em shared/.
 */

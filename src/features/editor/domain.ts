...
/**
 * Regras puras de extração de texto numerado do editor.
 *
 * A borda legada continua responsável por interpretar HTML/DOM; este módulo
 * recebe apenas os parágrafos já normalizados e devolve o texto final.
 */
export function extractTextWithNumbering(paragraphs = []) {
    const resultado = [];
    const counters = {
        'item-n1': 0,
        'item-n2': 0,

...
import { LLM_PROFILES_STORE_VERSION } from '../../../config/migrations/index.js';
...
/** Coordinated with src/config/migrations (ADR-0009 / Phase 2.6). */
const LEGACY_MIGRATION_VERSION = LLM_PROFILES_STORE_VERSION;

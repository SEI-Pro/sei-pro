...
export function monitoradosLabelOptions(id_procedimento) {
    ...
    return '<table style="font-size:10pt;width:100%;min-width:610px;" class="seiProForm">'
        ...
        + '<td><span class="seipro-monitorado-dates-editor"><input id="monitoradoPrazoSend" value="' + dateVal + '" style="width:120px;background:#f9fafa;" data-act="dates-hide-blur" data-key="dates" type="date" class="seipro-monitorado-dates" name="monitoradoPrazoSend">'
        ...
        + '<a class="newLink seipro-monitorado-tags-add" data-act="tags-show" style="font-size:10pt;"><i class="fas fa-tags"></i> Adicionar etiqueta</a>'
        + '</td></tr></table>';
}

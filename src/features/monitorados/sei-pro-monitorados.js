...
// insertIconMonitorados / appendIconMonitorados REESCRITOS em vanilla ESM:
// src/features/monitorados/icon.js (clique delegado no mundo isolado).
// Globais preservados via aliasGlobal no index.js do bundle.
